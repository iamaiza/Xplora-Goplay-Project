...
const WatchRingtonesPage = () => {
    ...
    const textQueries = 'max-lg:tw-w-96 max-sm:tw-text-sm max-sm:tw-w-64 max-sm:tw-mt-5 max-[500px]:tw-mt-0 max-[500px]:tw-w-[39%] max-[385px]:tw-w-[33%] max-[500px]:tw-leading-tight max-[350px]:tw-w-[6.2rem] max-[350px]:tw-mt-14 max-[350px]:tw-text-[13px]'

    const imgQueries = 'max-[900px]:tw-right-16 max-sm:tw-right-0 max-sm:-tw-bottom-6 max-[500px]:-tw-bottom-5 max-[350px]:tw-top-10 max-[350px]:tw-w-[6.5rem] max-[350px]:tw-h-[6.5rem] max-[350px]:-tw-right-2'
                    ...
                    <div className="tw-px-10 max-sm:tw-px-4">
                        <div className="tw-relative tw-h-56 max-[900px]:tw-h-40 max-sm:tw-h-52 max-[500px]:tw-h-36 max-[350px]:tw-h-[6.2rem] tw-overflow-hidden tw-rounded-xl">
                            ...
                            <div className="tw-text-white tw-w-[30rem] tw-ml-12 max-[900px]:tw-ml-8 tw-absolute tw-top-1/2 -tw-translate-y-1/2">
                                ...
                                >
                                    Xplora Watch Ringtones! Purchase various watch ringtones with your Xplora coins!
                                </div>
