...
const ArcadePage = () => {
    const textQueries = 'max-lg:tw-mt-3 max-lg:tw-w-96 max-[850px]:tw-w-80 max-sm:tw-w-60 max-lg:tw-text-[1.3rem] max-sm:tw-text-base max-[500px]:tw-w-[49%] max-[350px]:tw-mt-4'
    const arcadeBannerQueries = 'max-lg:tw-pl-10 max-sm:tw-pl-7 max-[500px]:tw-pl-[1.245rem] max-[350px]:tw-pl-[0.9rem] max-lg:tw-mt-3 max-sm:tw-mt-0'
    return (
        <div>
            <DashboardHeader />
            <div className="tw-flex">
                ...
                <div className="tw-pt-[8.7rem] max-xl:tw-pt-[7.5rem] max-sm:tw-pt-32 tw-w-full tw-max-h-screen tw-h-full tw-overflow-y-auto">
                    <div className="tw-px-10 max-sm:tw-px-4">
                        <div className="tw-relative tw-h-80 max-lg:tw-h-44 max-sm:tw-h-48">
                            ...
                            <img
                                ...
                                alt=""
                            />
                            <div className={`tw-absolute tw-top-1/2 -tw-translate-y-1/2 tw-pl-12 ${arcadeBannerQueries}`}>
                                ...
                                <div className={`tw-text-3xl tw-text-white tw-w-72 tw-leading-normal tw-mt-5 ${textQueries}`}>
