...
import { DashboardHeader, DashboardSidebar, AuctionsList, MarketplaceFooter } from './imports'
    ...
    return (
        <div>
            ...
            <div className="tw-flex">
                ...
                />
                <div className="tw-pt-[8.7rem] max-xl:tw-pt-[7.5rem] max-sm:tw-pt-28 tw-w-full tw-max-h-screen tw-h-full tw-overflow-y-auto">
                    <div className="tw-px-10  max-sm:tw-px-4">
                        <div
                            className="bg-linear tw-flex tw-items-center max-lg:tw-justify-between tw-gap-x-5 max-sm:tw-gap-x-1 tw-py-16 tw-px-[4.3rem] max-lg:tw-px-5 max-[350px]:tw-py-3 tw-rounded-3xl max-lg:tw-h-[22rem] max-sm:tw-h-auto max-sm:tw-py-6">
                            <div className="tw-text-white">
                                <div className="tw-text-[1.7rem] max-xl:tw-text-2xl max-sm:tw-leading-normal max-lg:tw-text-xl tw-tracking-wide tw-w-96 max-[800px]:tw-w-80 max-sm:tw-text-xs  max-sm:tw-w-60 max-[500px]:tw-w-44 max-[350px]:tw-w-28">
                                    Bid on the most desirable gadgets, games and
                                    more! New exciting lots are added every two
                                    weeks.
                                </div>
                            ...
                            <figure className="tw-w-[27rem] max-lg:tw-w-48 max-sm:-tw-mx-3">
                                <img
                                    ...
                                    alt=""
                                />
                                <img className="tw-w-full tw-object-cover tw-hidden max-lg:tw-block" src="https://goplay.myxplora.com/_nuxt/img/Group%2015476.b118e05.png" alt="" />
                            </figure>
                        </div>
