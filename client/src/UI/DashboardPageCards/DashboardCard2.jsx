...
const DashboardCard2 = ({ className1, cardHeading, cardText, cardText2 }) => {
  return (
    <>
        <Link className={`grid-card tw-w-full tw-pt-6 tw-px-4 max-lg:tw-h-[28rem] tw-text-white tw-text-center tw-rounded-[2rem] tw-relative ${className1}`}>
